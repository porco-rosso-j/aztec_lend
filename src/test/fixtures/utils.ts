...
import { AztecAddress, EthAddress, PXE_URL, TxStatus, Wallet } from "@aztec/aztec.js";
// import { TokenContract } from "@aztec/noir-contracts/dest/types/token.ts";
// import { TokenContract } from "@aztec/noir-contracts/dest/types";
...
export async function deployAndInitializeTokenAndBridgeContracts(
  ...
  console.log("tokenPortalAddress: ", tokenPortalAddress)
  console.log("token: ", token.address)
  // deploy l2 token bridge and attach to the portal
  const bridge = await TokenBridgeContract.deploy(pxeService, token.address)
